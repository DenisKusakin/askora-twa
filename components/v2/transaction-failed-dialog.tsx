...
export default function TransactionErrorDialog({content}: { content: ReactElement }) {
    useEffect(() => {
    ...
    return <div
        ...
        <div className={"flex flex-col items-center justify-center mt-20 w-full"}>
            ...
            <div className={"p-4 flex items-center justify-center flex-col"}>
                <div className={"text-lg"}>Failed to send a transaction</div>
                <div className={"text-xs mt-2"}>Please retry</div>
                <div className={"mt-5"}>
                    {content}
                </div>
            </div>
